// Hello This is a simple morse code converter in C language. It converts text to morse code and vice versa. It also has an option to print the output in a text file.
// Created by Fenil Bhalala on 26/4/2024.
    ...
    do
    {
        ...
        switch (option) {
            ...
            case 1:
                printf("\nEnter Text : ");
                scanf(" %[^\n]", input);
                strcpy(temp, morseCode(input[0]));
                for (int i = 1; i < strlen(input); i++) {
                    strcat(temp, " ");
                    strcat(temp, morseCode(input[i]));
                    // printf("%s ", morseCode(input[i])); if you don't want style of output then uncomment this line and comment the nessary line
                }
                lenth=strlen(temp);
                printf("+");
                for (int i = 1; i < lenth + 16; i++)
                {
                    printf("-");
                }
                printf("+\n");
                printf("| Morse Code : %s |", temp);
                printf("\n+");
                for (int i = 1; i < lenth + 16; i++)
                {
                    printf("-");
                ...
                printf("Do you want to print in text format? (1 for yes, 0 for no): ");
                scanf("%d", &txtprint);
                if (txtprint == 1){
